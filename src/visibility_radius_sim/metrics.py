...
def yearly_metrics(
    *,
    ...
    mean_phantom_candidate_count: float,
    mean_sampled_phantom_candidate_count: float,
    mean_selected_phantom_count: float,
    mean_phantom_selection_share: float,
    ...
    return {
        ...
        "mean_phantom_candidate_count": round(float(mean_phantom_candidate_count), precision),
        "mean_sampled_phantom_candidate_count": round(float(mean_sampled_phantom_candidate_count), precision),
        "mean_selected_phantom_count": round(float(mean_selected_phantom_count), precision),
        "mean_phantom_selection_share": round(float(mean_phantom_selection_share), precision),
